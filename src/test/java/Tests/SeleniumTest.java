...
public class SeleniumTest {
    ...
    @Test
    void ValidateFirstsneakerShoes() throws IOException, InterruptedException {
        test = extent.createTest("Validate First Sneaker shoes name", "This test validates first sneaker shoes on Products page");
